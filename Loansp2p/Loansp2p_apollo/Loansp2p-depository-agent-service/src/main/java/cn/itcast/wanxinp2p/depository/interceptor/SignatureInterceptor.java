package cn.itcast.Loansp2p.depository.interceptor;

import cn.itcast.Loansp2p.common.util.EncryptUtil;
import cn.itcast.Loansp2p.common.util.RSAUtil;
import cn.itcast.Loansp2p.depository.service.ConfigService;
...
public class SignatureInterceptor implements Interceptor {
    ...
    public static void main(String[] args) {
        String str = "http://sdfasdf?serviceName=Loansp2p&platformNo=Loansp2p&reqData=eyJhbW91bnQiOjExMTEsImJpelR5cGUiOiJURU5ERVIiLCJwcm9qZWN0Tm8iOiJQUk9fREQxMzAyRTQxQjA1NDZCMTk2Mjg2RkY2MTQ2Q0JCOUYiLCJyZXF1ZXN0Tm8iOiJSRVFfMjJDMjZDQzY0RkIyNEEyRjlCNjU2OUQ2MzgzQkEwMUIiLCJ1c2VyTm8iOiI0In0=";
