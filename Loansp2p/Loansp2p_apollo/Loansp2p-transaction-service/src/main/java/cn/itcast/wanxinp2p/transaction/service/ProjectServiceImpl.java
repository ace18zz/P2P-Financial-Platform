package cn.itcast.Loansp2p.transaction.service;

import cn.itcast.Loansp2p.api.consumer.model.BalanceDetailsDTO;
import cn.itcast.Loansp2p.api.consumer.model.ConsumerDTO;
import cn.itcast.Loansp2p.api.depository.model.LoanDetailRequest;
...
import cn.itcast.Loansp2p.api.transaction.model.*;
import cn.itcast.Loansp2p.common.domain.*;
import cn.itcast.Loansp2p.common.util.CodeNoUtil;
import cn.itcast.Loansp2p.common.util.CommonUtil;
import cn.itcast.Loansp2p.transaction.agent.ConsumerApiAgent;
import cn.itcast.Loansp2p.transaction.agent.ContentSearchApiAgent;
import cn.itcast.Loansp2p.transaction.agent.DepositoryAgentApiAgent;
import cn.itcast.Loansp2p.transaction.common.constant.TradingCode;
import cn.itcast.Loansp2p.transaction.common.constant.TransactionErrorCode;
import cn.itcast.Loansp2p.transaction.common.utils.IncomeCalcUtil;
import cn.itcast.Loansp2p.transaction.common.utils.SecurityUtil;
import cn.itcast.Loansp2p.transaction.entity.Project;
import cn.itcast.Loansp2p.transaction.entity.Tender;
import cn.itcast.Loansp2p.transaction.mapper.ProjectMapper;
import cn.itcast.Loansp2p.transaction.mapper.TenderMapper;
import cn.itcast.Loansp2p.transaction.message.P2pTransactionProducer;
import cn.itcast.Loansp2p.transaction.model.LoginUser;
