package cn.itcast.Loansp2p.uaa.config;


import cn.itcast.Loansp2p.uaa.domain.ClientDefaultAccessTokenConverter;
import cn.itcast.Loansp2p.uaa.domain.UnifiedUserAuthenticationConverter;
...
public class JWTConfig {
  ...
  private String SIGNING_KEY = "Loans123";
