package cn.itcast.Loansp2p.uaa.domain;


import cn.itcast.Loansp2p.common.util.DateUtil;
import cn.itcast.Loansp2p.uaa.common.utils.*;
import cn.itcast.Loansp2p.uaa.repository.PasswordHandler;
...
public class OauthClientDetailsDto implements Serializable {
    ...
    public OauthClientDetailsDto(OauthClientDetails clientDetails) {
        ...
        this.createTime = DateUtil.toDateTime(clientDetails.createTime());
